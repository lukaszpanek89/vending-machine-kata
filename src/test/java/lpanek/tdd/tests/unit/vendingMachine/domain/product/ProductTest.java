package lpanek.tdd.tests.unit.vendingMachine.domain.product;

import static lpanek.tdd.tests.vendingMachine.util.ConstructingUtil.price;
import static lpanek.tdd.tests.vendingMachine.util.ConstructingUtil.productType;
